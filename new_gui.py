...
class MainWindow(QMainWindowLog):
    ...
    def init_ui(self):
        ...
        self.Iron_blood_boss_before_39_pause_checkbox.setChecked(data.get("boss_before_39_pause_enabled", False))
    ...
    def save_ui_settings(self):
        ...
        data["boss_before_39_pause_enabled"] = self.Iron_blood_boss_before_39_pause_checkbox.isChecked()
    ...
    def update_dependent_controls_state(self):
        ...
        self.Iron_blood_boss_before_39_pause_checkbox.setEnabled(early_stop_enabled)
